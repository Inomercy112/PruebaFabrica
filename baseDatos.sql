...
create table error_actividad(
                                id smallint unsigned auto_increment primary key,
                                id_usuario_actividad smallint unsigned not null,
...
INSERT INTO tipo_interrupcion (nombre_tipo_interrupcion) VALUES
                                                             ('Reunión no planificada'),
                                                             ...
                                                             ('Fallas en el entorno de pruebas'),
                                                             ('Ataques de seguridad o vulnerabilidades detectadas');



create table interrupcion(id smallint unsigned auto_increment primary key,
